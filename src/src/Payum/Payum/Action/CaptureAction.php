...
final class CaptureAction implements ActionInterface, ApiAwareInterface
{
    ...
    public function execute($request): void
    {
        ...
        $data = [
            ...
            'currency1'=>$order->getCurrencyCode(),
            'merchant_id'=>$this->api->getMerchantId(),
            //'md5key'=>$this->api->getMd5Key(),
            ...
            'success_url'=>'http://127.0.0.1:8000/en_US/order/thank-you',
            'fail_url'=>'http://127.0.0.1:8000/en_US/order/thank-you',
            'pending_url'=>'http://127.0.0.1:8000/en_US/order/thank-you',
        ];
        try {
...
//curl封装
    ...
    {
        $this->record_logs('doing request');
        $headers = array(
            'MerNo:'.$merchant_id,
        );
        $ch = curl_init();
